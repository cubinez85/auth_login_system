Добрый день!
сам проект с Тестовым заданием можно пощупать в реальном времени:
https://login-auth.cubinez.ru/admin/
логин: tester_user
пароль: test123  (используется встроенная аутентификации Nginx)
Можно настроить еще Email verification — отправка подтверждения при регистрации, но в Тестовом задании такого требования не увидел.
Полную систему аутентификации и авторизации с Email verification — отправка подтверждения при регистрации можно протестировать на моем сайте:
через телеграм_бот: @cubinez85_flask_bot
или напрямую: https://www.flask.cubinez.ru/
